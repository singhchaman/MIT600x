...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self,story):
        return self._phrase in story.getTitle() or self._phrase in story.getSubject() or self._phrase in story.getSummary()
